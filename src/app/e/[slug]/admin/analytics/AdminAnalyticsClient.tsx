...
export default function AdminAnalyticsClient({
  ...
  const [sessions] = React.useState<Session[]>(initialSessions)
  const [tracks] = React.useState<Track[]>(initialTracks)
  const [members] = React.useState<EventMember[]>(initialMembers)
  const [votes] = React.useState<Vote[]>(initialVotes)
  const [timeSlots] = React.useState<TimeSlot[]>(initialTimeSlots)
  const [venues] = React.useState<Venue[]>(initialVenues)
